package leetcode;//给定一个整数数组 nums，按要求返回一个新数组 counts。数组 counts 有该性质： counts[i] 的值是 nums[i] 右侧小于 num
//s[i] 的元素的数量。 
//
// 示例: 
//
...
class Solution315_1 {
    ...
    public static void main(String[] args) {
        ...
        new Solution315_1().countSmaller(nums);
    }
}
...
class Solution315_2 {
    ...
    public static void main(String[] args) {
        int[] nums = new int[]{5, 2, 6, 1};
        new Solution315_2().countSmaller(nums);
    }
}
