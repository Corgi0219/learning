package leetcode.c201_300;//给定一个二叉树，返回所有从根节点到叶子节点的路径。
//
// 说明: 叶子节点是指没有子节点的节点。 
//
// 示例: 
 ...
 */
class Solution257 {
    public List<String> binaryTreePaths(leetcode.TreeNode root) {
    ...
    private void dfs(leetcode.TreeNode node, String path, List<String> res) {
...
class Solution257V1 {
    ...
    private void dfs(leetcode.TreeNode node, StringBuilder path, List<String> res) {
    ...
    public static void main(String[] args) {
        ...
        new Solution257V1().binaryTreePaths(node);
    }
}
