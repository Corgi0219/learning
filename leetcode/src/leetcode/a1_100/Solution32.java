package leetcode.a1_100;//给定一个只包含 '(' 和 ')' 的字符串，找出最长的包含有效括号的子串的长度。
//
// 示例 1: 
//
// 输入: "(()"
...
class Solution32V1 {
    ...
    public static void main(String[] args) {
        System.out.println(new Solution32V1().longestValidParentheses("()"));
    }
}
...
class Solution32V2 {
    ...
    public static void main(String[] args) {
        System.out.println(new Solution32V2().longestValidParentheses("()"));
    }
}
...
class Solution32V3 {
    ...
    public static void main(String[] args) {
        System.out.println(new Solution32V3().longestValidParentheses("()(()"));
    }
}
