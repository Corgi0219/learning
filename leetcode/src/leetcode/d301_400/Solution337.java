package leetcode.d301_400;//在上次打劫完一条街道之后和一圈房屋后，小偷又发现了一个新的可行窃的地区。这个地区只有一个入口，我们称之为“根”。 除了“根”之外，每栋房子有且只有一个“父“
...
class Solution337DFS {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new Solution337DFS().rob(treeNode));
    }
}
